...
var _ = Describe("Feature Gates", func() {
	DescribeTable("check IsEnabled", func(fgs featuregates.HyperConvergedFeatureGates, fgName string, expected gtypes.GomegaMatcher) {
		...
		Entry("unknown FG; not in list", featuregates.HyperConvergedFeatureGates{{Name: "DownwardMetricS", State: new(featuregates.Enabled)}}, "unknown", BeFalse()),
		...
		Entry("known alpha FG; not in list;", featuregates.HyperConvergedFeatureGates{{Name: "alignCPUs", State: new(featuregates.Enabled)}}, "downwardMetrics", BeFalse()),
		...
		Entry("known beta FG; not in list;", featuregates.HyperConvergedFeatureGates{{Name: "template", State: new(featuregates.Enabled)}}, "declarativeHotplugVolumes", BeTrue()),
