...
func (in *HyperConvergedSpec) DeepCopyInto(out *HyperConvergedSpec) {
	*out = *in
	...
	if in.KubeVirtFeatureGates != nil {
		in, out := &in.KubeVirtFeatureGates, &out.KubeVirtFeatureGates
		*out = make(KubeVirtFeatureGates, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in KubeVirtFeatureGates) DeepCopyInto(out *KubeVirtFeatureGates) {
	{
		in := &in
		*out = make(KubeVirtFeatureGates, len(*in))
		copy(*out, *in)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubeVirtFeatureGates.
func (in KubeVirtFeatureGates) DeepCopy() KubeVirtFeatureGates {
	if in == nil {
		return nil
	}
	out := new(KubeVirtFeatureGates)
	in.DeepCopyInto(out)
	return *out
}
