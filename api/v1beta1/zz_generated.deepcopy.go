...
import (
	apiv1 "github.com/kubevirt/hyperconverged-cluster-operator/api/v1"
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CpuModelInfo) DeepCopyInto(out *CpuModelInfo) {
	*out = *in
	if in.CPU != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CpuModelInfo.
func (in *CpuModelInfo) DeepCopy() *CpuModelInfo {
	if in == nil {
		return nil
	}
	out := new(CpuModelInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HyperConvergedSpec) DeepCopyInto(out *HyperConvergedSpec) {
	*out = *in
	...
	if in.PermittedHostDevices != nil {
		...
		*out = new(apiv1.PermittedHostDevices)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.HigherWorkloadDensity != nil {
		...
		*out = new(apiv1.HigherWorkloadDensityConfiguration)
		**out = **in
	}
	if in.EnableCommonBootImageImport != nil {
		in, out := &in.EnableCommonBootImageImport, &out.EnableCommonBootImageImport
...
func (in *NodeInfoStatus) DeepCopyInto(out *NodeInfoStatus) {
	*out = *in
	...
	if in.RecommendedCpuModels != nil {
		in, out := &in.RecommendedCpuModels, &out.RecommendedCpuModels
		*out = make([]CpuModelInfo, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
