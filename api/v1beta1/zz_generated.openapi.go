...
func schema_kubevirt_hyperconverged_cluster_operator_api_v1beta1_HyperConverged(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/kubevirt/hyperconverged-cluster-operator/api/v1.HyperConvergedStatus", "github.com/kubevirt/hyperconverged-cluster-operator/api/v1beta1.HyperConvergedSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"declarativeHotplugVolumes": {
						SchemaProps: spec.SchemaProps{
							Description: "DeclarativeHotplugVolumes enables the use of the declarative volume hotplug feature in KubeVirt.",
							Default:     true,
							Type:        []string{"boolean"},
							Format:      "",
						},
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"changedBlockTrackingLabelSelectors": {
						SchemaProps: spec.SchemaProps{
							Description: "ChangedBlockTrackingLabelSelectors defines label selectors. VMs matching these selectors will have changed block tracking enabled. Enabling changed block tracking is mandatory for performing incremental backups.",
