			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"liveUpdateConfiguration": {
						SchemaProps: spec.SchemaProps{
							Description: "LiveUpdateConfiguration holds cluster configuration for live update features - max cpu sockets, max guest memory and max hotplug ratio. This setting can affect VM CPU and memory settings.",
