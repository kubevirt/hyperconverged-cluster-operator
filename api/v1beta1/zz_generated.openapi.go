			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"kubeMacPoolConfiguration": {
						SchemaProps: spec.SchemaProps{
							Description: "KubeMacPoolConfiguration holds kubemacpool MAC address range configuration. Once set, the range values are immutable and cannot be changed.",
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"rangeStart": {
						SchemaProps: spec.SchemaProps{
							Description: "RangeStart defines the first MAC address in the kubemacpool range. The MAC address format should be AA:BB:CC:DD:EE:FF. This field is immutable once set.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"rangeEnd": {
						SchemaProps: spec.SchemaProps{
							Description: "RangeEnd defines the last MAC address in the kubemacpool range. The MAC address format should be AA:BB:CC:DD:EE:FF. This field is immutable once set.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
