...
The latest bundle is `quay.io/kubevirt/hyperconverged-cluster-bundle:1.19.0-unstable`. It is built and pushed on every merge to
...
that bundle: `quay.io/kubevirt/hyperconverged-cluster-index:1.19.0-unstable`.
...
spec:
  sourceType: grpc
  image: quay.io/kubevirt/hyperconverged-cluster-index:1.19.0-unstable
