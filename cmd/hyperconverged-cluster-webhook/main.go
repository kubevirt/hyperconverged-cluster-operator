...
func main() {
	...
	err = cmdcommon.ClusterInitializations(ctx, apiClient, logger)
	...
	eventEmitter.Init(ownresources.GetPod(), ownresources.GetCSV(), mgr.GetEventRecorderFor(hcoutil.HyperConvergedName))
