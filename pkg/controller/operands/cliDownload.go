...
func NewConsoleCLIDownload(hc *hcov1beta1.HyperConverged) *consolev1.ConsoleCLIDownload {
	baseUrl := "https://" + downloadsServiceName + "-" + hc.Namespace + "." + hcoutil.GetClusterInfo().GetDomain()
...
func newDownloadsServiceHandler(Client client.Client, Scheme *runtime.Scheme) *cliDownloadServiceHandler {
	return &cliDownloadServiceHandler{
		...
		removeExistingOwner:    false,
		setControllerReference: false,
		hooks:                  &downloadsServiceHooks{},
	}
}

type downloadsServiceHooks struct{}

func (h downloadsServiceHooks) getFullCr(hc *hcov1beta1.HyperConverged) (client.Object, error) {
	return NewDownloadsService(hc), nil
}

func (h downloadsServiceHooks) getEmptyCr() client.Object {
	return &corev1.Service{}
}

func (h downloadsServiceHooks) getObjectMeta(cr runtime.Object) *metav1.ObjectMeta {
	return &cr.(*corev1.Service).ObjectMeta
}

func (h *downloadsServiceHooks) updateCr(req *common.HcoRequest, Client client.Client, exists runtime.Object, required runtime.Object) (bool, bool, error) {
...
func NewDownloadsService(hc *hcov1beta1.HyperConverged) *corev1.Service {

	return &corev1.Service{
		ObjectMeta: metav1.ObjectMeta{
			Name:      downloadsServiceName,
		...
		Spec: corev1.ServiceSpec{
			...
			Ports: []corev1.ServicePort{
				{
					Name:       strconv.Itoa(util.DownloadsServerPort),
					Port:       util.DownloadsServerPort,
					Protocol:   corev1.ProtocolTCP,
					TargetPort: intstr.FromInt(util.DownloadsServerPort),
				},
			},
		},
	}
...
func newDownloadsRouteHandler(Client client.Client, Scheme *runtime.Scheme) *cliDownloadRouteHandler {
	return &cliDownloadRouteHandler{
		...
		removeExistingOwner:    false,
		setControllerReference: false,
		hooks:                  &downloadsRouteHooks{},
	}
}

type downloadsRouteHooks struct{}

func (h downloadsRouteHooks) getFullCr(hc *hcov1beta1.HyperConverged) (client.Object, error) {
	return NewDownloadsRoute(hc), nil
}

func (h downloadsRouteHooks) getEmptyCr() client.Object {
	return &routev1.Route{}
}

func (h downloadsRouteHooks) getObjectMeta(cr runtime.Object) *metav1.ObjectMeta {
	return &cr.(*routev1.Route).ObjectMeta
}

func (h *downloadsRouteHooks) updateCr(req *common.HcoRequest, Client client.Client, exists runtime.Object, required runtime.Object) (bool, bool, error) {
...
func NewDownloadsRoute(hc *hcov1beta1.HyperConverged) *routev1.Route {
	weight := int32(100)
	return &routev1.Route{
		ObjectMeta: metav1.ObjectMeta{
			Name:      downloadsServiceName,
		...
		Spec: routev1.RouteSpec{
			Port: &routev1.RoutePort{
				TargetPort: intstr.IntOrString{IntVal: util.DownloadsServerPort},
			},
