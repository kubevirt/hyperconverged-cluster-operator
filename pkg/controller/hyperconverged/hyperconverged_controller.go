...
import (
	...
	hcov1alpha1 "github.com/kubevirt/hyperconverged-cluster-operator/hyperconverged-cluster-operator/pkg/apis/hco/v1alpha1"
...
func (r *ReconcileHyperConverged) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling HyperConverged")
...
func newPodForCR(cr *hcov1alpha1.HyperConverged) *corev1.Pod {
