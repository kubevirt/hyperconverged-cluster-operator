...
const (
	...
	VmFileRestoreOperatorVersionEnvV        = "VM_FILE_RESTORE_OPERATOR_VERSION"
	...
	HCOV1Beta1WebhookPath               = "/validate-hco-kubevirt-io-v1beta1-hyperconverged"
	HCOV1WebhookPath                    = "/validate-hco-kubevirt-io-v1-hyperconverged"
...
const (
	...
	AppComponentVmFileRestore       AppComponent = "vm-file-restore"
