...
const (
	...
	MigrationCapacityValidatorWebhook = "validate-migration-capacity-hco.kubevirt.io"
	...
	HCOMigrationCapacityWebhookPath       = "/validate-migration-capacity-hco.kubevirt.io"
