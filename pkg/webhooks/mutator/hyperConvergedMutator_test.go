...
var _ = Describe("test HyperConverged v1 mutator", func() {
	...
	Context("Check mutating webhook for create operation", func() {
		...
		DescribeTable("migrate disableMDevConfiguration to mediatedDevicesConfiguration.enabled on create",
			func(ctx context.Context, featureGates hcov1fg.HyperConvergedFeatureGates, mdc *hcov1.MediatedDevicesConfiguration, extraPatches []jsonpatch.JsonPatchOperation) {
			...
			Entry("should set enabled=false when disableMDevConfiguration is enabled and mediatedDevicesConfiguration is unset",
				hcov1fg.HyperConvergedFeatureGates{{Name: "disableMDevConfiguration"}},
				nil,
				[]jsonpatch.JsonPatchOperation{{
					Operation: "add",
			...
			Entry("should set enabled=false when disableMDevConfiguration is enabled and enabled is unset",
				hcov1fg.HyperConvergedFeatureGates{{Name: "disableMDevConfiguration"}},
				...
				[]jsonpatch.JsonPatchOperation{{
					Operation: "add",
					Path:      v1HyperConvergedMdevConfigPath + "/enabled",
					Value:     false,
				}},
			),
			Entry("should do nothing when disableMDevConfiguration is explicitly disabled",
				hcov1fg.HyperConvergedFeatureGates{{Name: "disableMDevConfiguration", State: new(hcov1fg.Disabled)}},
				&hcov1.MediatedDevicesConfiguration{
					MediatedDeviceTypes: []string{"nvidia-222", "nvidia-230"},
				},
				nil,
			),
			Entry("should do nothing when disableMDevConfiguration is unset",
			...
			Entry("should not override enabled when already set",
				hcov1fg.HyperConvergedFeatureGates{{Name: "disableMDevConfiguration"}},
				&hcov1.MediatedDevicesConfiguration{
					Enabled:             new(true),
					MediatedDeviceTypes: []string{"nvidia-222", "nvidia-230"},
	...
	Context("Check mutating webhook for update operation", func() {
		...
		DescribeTable("sync disableMDevConfiguration and mediatedDevicesConfiguration.enabled on update",
			func(ctx context.Context, origCR, newCR *hcov1.HyperConverged, expectedPatches []jsonpatch.JsonPatchOperation) {
			...
			Entry("should set enabled=false when only disableMDevConfiguration is enabled",
				...
				&hcov1.HyperConverged{
					Spec: hcov1.HyperConvergedSpec{
						FeatureGates: hcov1fg.HyperConvergedFeatureGates{{Name: "disableMDevConfiguration"}},
						Virtualization: hcov1.VirtualizationConfig{
							MediatedDevicesConfiguration: &hcov1.MediatedDevicesConfiguration{
								MediatedDeviceTypes: []string{"nvidia-222"},
							},
			...
			Entry("should add disableMDevConfiguration when only enabled is set to false",
				&hcov1.HyperConverged{
					Spec: hcov1.HyperConvergedSpec{
						Virtualization: hcov1.VirtualizationConfig{
							MediatedDevicesConfiguration: &hcov1.MediatedDevicesConfiguration{
				...
				[]jsonpatch.JsonPatchOperation{{
					...
					Value:     hcov1fg.FeatureGate{Name: "disableMDevConfiguration"},
				}},
			),
			Entry("should remove disableMDevConfiguration when only enabled is set to true",
				&hcov1.HyperConverged{
					Spec: hcov1.HyperConvergedSpec{
						FeatureGates: hcov1fg.HyperConvergedFeatureGates{{Name: "disableMDevConfiguration"}},
						Virtualization: hcov1.VirtualizationConfig{
			...
			Entry("should remove enabled when only disableMDevConfiguration is disabled",
				&hcov1.HyperConverged{
					Spec: hcov1.HyperConvergedSpec{
						FeatureGates: hcov1fg.HyperConvergedFeatureGates{{Name: "disableMDevConfiguration"}},
						Virtualization: hcov1.VirtualizationConfig{
				...
				&hcov1.HyperConverged{
					Spec: hcov1.HyperConvergedSpec{
						FeatureGates: hcov1fg.HyperConvergedFeatureGates{
							{Name: "disableMDevConfiguration", State: new(hcov1fg.Disabled)},
						},
						Virtualization: hcov1.VirtualizationConfig{
							MediatedDevicesConfiguration: &hcov1.MediatedDevicesConfiguration{
								Enabled:             new(false),
			...
			Entry("should remove mediatedDevicesConfiguration when disableMDevConfiguration is disabled and only enabled is set",
				&hcov1.HyperConverged{
					Spec: hcov1.HyperConvergedSpec{
						FeatureGates: hcov1fg.HyperConvergedFeatureGates{{Name: "disableMDevConfiguration"}},
						Virtualization: hcov1.VirtualizationConfig{
			...
			Entry("should not remove enabled when disableMDevConfiguration is disabled and enabled was never set",
				&hcov1.HyperConverged{
					Spec: hcov1.HyperConvergedSpec{
						FeatureGates: hcov1fg.HyperConvergedFeatureGates{{Name: "disableMDevConfiguration"}},
						Virtualization: hcov1.VirtualizationConfig{
