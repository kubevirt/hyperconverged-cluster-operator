...
var (
	...
	dictWithSupportedArchitectures = operatormetrics.NewGaugeVec(
		operatormetrics.MetricOpts{
			...
			Help: "Indicates whether the DataImportCronTemplate has supported architectures (0) or it has not (1)",
		},
	...
	dictWithArchitectureAnnotation = operatormetrics.NewGaugeVec(
		operatormetrics.MetricOpts{
			...
			Help: "Indicates whether the DataImportCronTemplate the ssp.kubevirt.io/dict.architectures annotation (0) or it has not (1)",
		},
		[]string{counterLabelDICTName, counterLabelDSName},
	)
)
