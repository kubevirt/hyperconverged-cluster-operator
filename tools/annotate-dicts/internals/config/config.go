...
func init() {
	...
	flag.BoolFunc("i", "Update the DataImportCronTemplate files with the updated architectures. Can't be used with the --output flag", func(s string) error {
		if strings.TrimSpace(s) == "" {
			cfg.shouldUpdate = true
			return nil
		}
