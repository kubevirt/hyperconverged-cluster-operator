...
const (
	...
	packageName         = hcoutil.HyperConvergedName
...
func getHcoCsv() {
	...
	installStrategyBase := getInstallStrategyBase(params)
	...
	csvBase.Spec.MinKubeVersion = minKubeVersion
				...
				Owned: []csvv1alpha1.CRDDescription{
					{
						...
						Version:     hcoutil.CurrentAPIVersion,
						Kind:        hcoutil.HyperConvergedKind,
...
func getCsvBaseParams(version semver.Version) *csvBaseParams {
	return &csvBaseParams{
		Name:            operatorName,
		Namespace:       *namespace,
