...
func (in *Cluster) DeepCopyInto(out *Cluster) {
	*out = *in
	if in.WorkloadArchitectures != nil {
		in, out := &in.WorkloadArchitectures, &out.WorkloadArchitectures
...
func (in *SSPSpec) DeepCopyInto(out *SSPSpec) {
	*out = *in
	if in.EnableMultipleArchitectures != nil {
		in, out := &in.EnableMultipleArchitectures, &out.EnableMultipleArchitectures
		*out = new(bool)
		**out = **in
	}
