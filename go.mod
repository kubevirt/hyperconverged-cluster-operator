...
require (
	...
	github.com/kubevirt/cluster-network-addons-operator v0.53.7
	...
	kubevirt.io/client-go v0.41.3
	kubevirt.io/containerized-data-importer v1.34.2
	kubevirt.io/controller-lifecycle-operator-sdk v0.2.0
	kubevirt.io/kubevirt v0.41.3
	kubevirt.io/qe-tools v0.1.7
	kubevirt.io/ssp-operator v0.11.4
...
replace (
	...
	kubevirt.io/client-go => kubevirt.io/client-go v0.41.3
)

// Aligning with https://github.com/kubevirt/containerized-data-importer/blob/release-v1.34.2
replace (
