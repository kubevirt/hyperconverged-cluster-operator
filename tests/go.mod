...
require (
	...
	kubevirt.io/application-aware-quota v1.1.13
	kubevirt.io/controller-lifecycle-operator-sdk/api v0.2.4
	kubevirt.io/managed-tenant-quota v1.2.1
	kubevirt.io/ssp-operator/api v0.19.1
)
...
replace (
	...
	github.com/kubevirt/cluster-network-addons-operator => github.com/kubevirt/cluster-network-addons-operator v0.91.1
	github.com/kubevirt/cluster-network-addons-operator/pkg/apis => github.com/kubevirt/cluster-network-addons-operator/pkg/apis v0.91.1
