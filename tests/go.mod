...
require (
	github.com/kubevirt/cluster-network-addons-operator v0.76.2
...
replace (
	...
	github.com/kubevirt/cluster-network-addons-operator => github.com/kubevirt/cluster-network-addons-operator v0.76.2
	github.com/kubevirt/cluster-network-addons-operator/pkg/apis => github.com/kubevirt/cluster-network-addons-operator/pkg/apis v0.76.2
