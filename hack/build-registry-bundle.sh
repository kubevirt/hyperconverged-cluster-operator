...
$CONTAINER_BUILD_CMD build ${REGISTRY_EXTRA_BUILD_ARGS} --no-cache -t ${IMAGE_REGISTRY}/${REGISTRY_NAMESPACE}/${REGISTRY_IMAGE_NAME}:${CONTAINER_TAG} -f $REGISTRY_DOCKERFILE .
