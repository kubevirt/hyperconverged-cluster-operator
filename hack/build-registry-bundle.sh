...
REGISTRY_EXTRA_PUSH_ARGS="${REGISTRY_EXTRA_PUSH_ARGS:-}"
...
$CONTAINER_BUILD_CMD push ${REGISTRY_EXTRA_PUSH_ARGS} ${IMAGE_REGISTRY}/${REGISTRY_NAMESPACE}/${REGISTRY_IMAGE_NAME}:${CONTAINER_TAG}
