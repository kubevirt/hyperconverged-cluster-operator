...
cat old.txt
echo diff old.txt "hack/tlsprofiles/old.expected${FIPS}"
...
echo diff intermediate.txt "hack/tlsprofiles/intermediate.expected${FIPS}"
check_ssp_up
...
cat modern.txt
echo diff modern.txt "hack/tlsprofiles/modern.expected${FIPS}"
check_ssp_up
...
cat custom.txt
echo diff custom.txt "hack/tlsprofiles/custom.expected${FIPS}"
check_ssp_up
...
cat default.txt
echo diff default.txt "hack/tlsprofiles/intermediate.expected${FIPS}"
