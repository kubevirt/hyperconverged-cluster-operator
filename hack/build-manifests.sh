...
DOWNLOADS_IMAGE=${DOWNLOADS_IMAGE:-quay.io/kubevirt/virt-artifacts-server:${CSV_VERSION}-unstable}
...
${PROJECT_ROOT}/tools/manifest-templator/manifest-templator \
  ...
  --downloads-image="${DOWNLOADS_IMAGE}"
...
${PROJECT_ROOT}/tools/csv-merger/csv-merger \
  ...
  --downloads-image-name="${DOWNLOADS_IMAGE}" > "${CSV_DIR}/${OPERATOR_NAME}.v${CSV_VERSION}.${CSV_EXT}"
