...
var (
	iommufdDevicePluginResourceCPU    = resource.MustParse("100m")
				...
				Containers: []corev1.Container{
					{
						...
						Resources: corev1.ResourceRequirements{
							Requests: corev1.ResourceList{
								corev1.ResourceCPU:    iommufdDevicePluginResourceCPU,
								corev1.ResourceMemory: iommufdDevicePluginResourceMemory,
							},
						},
