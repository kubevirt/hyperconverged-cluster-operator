...
| namespaceSelector | NamespaceSelector determines in which namespaces scheduling gate will be added to pods.. | *[metav1.LabelSelector](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.34/#labelselector-v1-meta) |  | false |
...
| utilityVolumes | UtilityVolumes enables the use of utility volumes in KubeVirt. Note: This feature is in Tech Preview. | *bool | false | false |
| incrementalBackup | IncrementalBackup enables to perform changed block tracking backups and incremental backups using QEMU capabilities in KubeVirt. Note: This feature is in Tech Preview. | *bool | false | false |
