...
| passtNetworkBinding | passtNetworkBinding deploys the needed configurations for kubevirt users to be able to use passt network binding plugin. Note: this feature is in Developer Preview. | *bool | false | false |
...
| controlPlaneNodesArchitecture | ControlPlaneNodesArchitecture is a distinct list of the CPU architecture of the control-plane nodes. | []string |  | false |
