...
| disableMDevConfiguration | Deprecated: use spec.mediatedDevicesConfiguration.enabled instead. This field is still read for backward compatibility and will be removed in a future API version. | *bool |  | false |
