...
| liveUpdateConfiguration | LiveUpdateConfiguration holds cluster configuration for live update features - max cpu sockets, max guest memory and max hotplug ratio. This setting can affect VM CPU and memory settings. | *v1.LiveUpdateConfiguration |  | false |
