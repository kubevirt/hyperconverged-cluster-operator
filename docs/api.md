...
| deployCommonInstanceTypesByVirtOperator | Enable deploying common instance types using virt-operator. If this is not set, then common instance types are deployed by SSP operator. This feature gate is used to allow gradual update, because common instance types in SSP operator will be deprecated and removed in the future. | *bool | false | false |
