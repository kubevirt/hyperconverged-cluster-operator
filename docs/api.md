...
| deployTektonTaskResources | deploy resources (kubevirt tekton tasks and example pipelines) in SSP operator Deprecated: This feature gate can only be used to remove tekton resources by setting it to \"false\". | *bool | false | false |
