...
| inheritScratchSpaceStorageClass | InheritScratchSpaceStorageClass enables scratch space PVCs to inherit the storage class of the target owner PVC instead of using the default storage class. Note: This feature is in Tech Preview | alpha |
