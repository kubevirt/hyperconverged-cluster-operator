...
When the RebootPolicy Feature Gate is enabled, it is possible to the reboot policy
for a VM, specifies how the domain should behave when a guest reboot is triggered.
