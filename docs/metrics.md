...
Indicates whether the DataImportCronTemplate the ssp.kubevirt.io/dict.architectures annotation (0) or it has not (1). Type: Gauge.

### kubevirt_hco_dataimportcrontemplate_with_supported_architectures
Indicates whether the DataImportCronTemplate has supported architectures (0) or it has not (1). Type: Gauge.
